...
@router.get("/view", response_model=response.APIResponse)
async def view_application_json(
    
):
    # current_user: dict = (Depends(get_current_user),)
    logo_path = "Emblem_of_India.png"
    
    # nocRegId = current_user["stake_user"]
    nocRegId = "NOC20260514153202"
    applicationData = {
        "applicantDetails": {
            "entityType": "Society",
            "applicantName": "Tanmay",
        ...
        "documentData": [
            {
                "fieldName": "proposalForCampusDevelopmentProgram",
                ...
                "filePath": "https://example.com/campus-development-proposal",
            },
            {
                "fieldName": "experienceAndExpertiseInDiscipline",
                "label": "The experience and expertise in the concerned discipline",
                "filePath": "https://example.com/campus-development-proposal",
            },
            {
                "fieldName": "feeStructureProposal",
...
def download_application(
    ...
    # Render HTML
    html_content = templates.get_template("applicant_noc_profile_view_pdf.html").render(**data)
