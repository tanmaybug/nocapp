...
def dtotodb(data: RegistrationFormRequestDTO, regId: str, client_ip:str) -> NOCRegistration:
    result = NOCRegistration(
        ...
        minority_flag=data.minorityTypeId,
        ...
        institution_address=data.collegeLocation.collegeAddress,
        ...
        minority_language_id_fk=data.languageId,
        minority_religion_id_fk=data.religionId,
        applicant_designation_id_fk=data.designationId,
    )
