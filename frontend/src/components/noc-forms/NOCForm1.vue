<template>
  <v-row class="pa-2">
    ...
    <v-col cols="12">
      <v-text-field v-model="modelValue.collegeLandAreaInAcres" label="Area of land for the college (in acres)" type="number" step="0.01" @input="updateValue" />
    </v-col>

    <!-- 4. Area of covered/built-up space -->
    <v-col cols="12">
      <v-text-field v-model="modelValue.collegeCoveredArea" label="Area of covered/ built-up space (in sq meter)" type="number" step="0.01" @input="updateValue" />
    </v-col>
    ...
    <v-col cols="12">
      ...
      <v-radio-group v-model="modelValue.landStatus.landConvertedForEducationalPurposeStatus" row @update:model-value="updateValue">
        <v-radio v-for="option in yesNoOptions" :key="option.value" :label="option.label" :value="option.value" />
      </v-radio-group>
    </v-col>
    ...
    <v-col cols="12">
      <v-textarea v-model="modelValue.comprehensivePlan" label="Comprehensive plan for the proposed college" rows="3" @input="updateValue" />
    </v-col>
